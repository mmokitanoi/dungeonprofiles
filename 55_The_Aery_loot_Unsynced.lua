local tbl = {
	...
	advancedavoid = {
		[1] = {castingid = 3910, type = "singlefixed", pos = {[1] = {x = 38.08, y = 148.39, z = -244.93}}, desc = "last boss hide with estenien"},
	},
	overheadmarkers = {
	},
	puddledata= {
	...
	tankat = {
		[1] = {contentid = 3452, frompercent = 100, topercent = 0, pos = {x = 321.80, y = 93.99, z = -199.66}, desc = "tank first boss away from party from 100-0%"},
		[2] = {contentid = 3458, frompercent = 100, topercent = 0, pos = {x = 30.38, y = 148.39, z = -281.19}, desc = "tank last boss away from party from 100-0%"},
	},		
}
return tbl