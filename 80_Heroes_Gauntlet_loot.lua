local tbl = {
	...
	advancedavoid = {
		[1] = {castingid = 20436, type = "singlefixed", pos = {[1] = {x = -680.39, y = -23.99, z = 448.36}}, desc = "first boss shadowdash"},
        [2] = {castingid = 20994, type = "singlefixed", pos = {[1] = {x = 750.02, y = 8, z = 481.99}}, desc = "last boss crater knockback"},
		[3] = {castingid = 20998, type = "movetoentity", entitylist = "contentid=9511,maxdistance=30", targetable = false, pos = {x=735.87,y=8,z=481.65}, distfrompos = 4, casttime = 1, delay = -4, desc = "last boss blue pool"},
		[4] = {castingid = 20998, type = "movetoentity", entitylist = "contentid=9511,maxdistance=30", targetable = false, pos = {x=763.28,y=8,z=482.20}, distfrompos = 4, casttime = 1, delay = -4, desc = "last boss blue pool"},		

    },
    tankat= {
        [1] = {contentid = 9511, frompercent = 100, topercent = 0, pos = {x = 750.05, y = 8, z = 496.30}, desc = "tank last boss at center"},
    },	
	puddledata= {
        [1] = {castid = 20388, radius= 10, duration = 30, desc = "Puddle left at second boss"},
    },
	hasbuff = { 
		[1] = {type = "move", buffid = 2309, pos = {[1] = {x = 749.90, y = 8, z = 482.75},[2] = {x = 749.90, y = 8, z = 482.75},[3] = {x = 749.90, y = 8, z = 482.75},[4] = {x = 749.90, y = 8, z = 482.75}}, stacksrequired=1},
	},	
	overheadmarkers = {
	[1] = {id = 229, 
		   contentid = "9511",
           ...
           type = "move", 
           detectwho = "me", 
           pos =  {[1] = {x = 744.84, y = 8, z = 496.80}, [2] = {x = 744.35, y = 8, z = 473.68}, [3] = {x = 753.86, y = 8, z = 466.57}, [4] = {x = 755.92, y = 8, z = 489.49}}, 
           timetoreturn = 15,
		   },
	},
	limitbreak = {
	...
	tethers = {
		...
		[3] = {id = 17, type = "move", priority = 1, pos = {[1] = {[1] = {x = -450.89, y = 0, z = -531.97}, [2] = {x = -458.90, y = 1.19, z = -531.26}, [3] = {x = -441.77, y = 0, z = -532.75},}, [2] = {[1] = {x = -450.89, y = 0, z = -531.97}, [2] = {x = -458.90, y = 1.19, z = -531.26}, [3] = {x = -441.77, y = 0, z = -532.75},}, [3] = {[1] = {x = -450.89, y = 0, z = -531.97}, [2] = {x = -458.90, y = 1.19, z = -531.26}, [3] = {x = -441.77, y = 0, z = -532.75},}, [4] = {[1] = {x = -450.89, y = 0, z = -531.97}, [2] = {x = -458.90, y = 1.19, z = -531.26}, [3] = {x = -441.77, y = 0, z = -532.75},}}, desc = "Second Boss normal tether"},
