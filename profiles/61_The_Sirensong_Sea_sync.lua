local tbl = {
		...
		overheadmarkers = {
			[1] = {id = 62, 
               ...
               type = "move", 
               detectwho = "any",
               pos =  {[1] = {x=-2.7, y= 2.9, z= -208},[2] = {x=-2.7, y= 2.9, z= -208},[3] = {x=-2.7, y= 2.9, z= -208},[4] = {x=-2.7, y= 2.9, z= -208}}, 
               timetoreturn = 5},
			[1] = {id = 22, 
               contentid = "6072",
               desc= "spread", 
               type = "move", 
               detectwho = "me", 
               pos =  {[1] = {x=11.2,y=4.45,z=79.01},[2] = {x=8.01,y=4.44,z=96.82},[3] = {x=-26.7,y=4.44,z=79.07},[4] = {x=-1.32,y=4.43,z=62.33}}, 
               returnpos = {[1] = {x=-8.02,y=4.44,z=79.09},[2] = {x=-8.02,y=4.44,z=79.09},[3] = {x=-8.02,y=4.44,z=79.09},[4] = {x=-8.02,y=4.44,z=79.09}}, 
               timetoreturn = 5},			   
        },
		ignoretarget = {},
		interacts = {
