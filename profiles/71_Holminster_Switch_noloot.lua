local tbl = {
  ...
  tankat = {
    [1] = {
      ...
      frompercent = 100,
      topercent = 0,
      pos = { x = 78.22, y = 0, z = -100.55 },
      desc = "tank second boss at north",
    },
    [2] = {
      contentid = 8301,
      frompercent = 100,
      topercent = 0,
      pos = { x = 133.71, y = 23, z = -474.53 },
      desc = "tank last boss at north",
    },
    [3] = {
      contentid = 8299,
      frompercent = 100,
      topercent = 0,
      pos = { x = -15.11, y = 0, z = 225.83 },
      desc = "tank first boss at north",
    },
  },
  overheadmarkers = {
    [1] = {
      ...
      detectwho = "any",
      pos = {
        [1] = { x = 77.10, y = 0, z = -82.57 },
        [2] = { x = 77.10, y = 0, z = -82.57 },
        [3] = { x = 77.10, y = 0, z = -82.57 },
        [4] = { x = 77.10, y = 0, z = -82.57 },
      },
      timetoreturn = 15,
    },
    [2] = {
    ...
    [4] = {
      ...
      detectwho = "me",
      pos = {
        [1] = { x = 72.95, y = 1.19, z = -93.93 },
        [2] = { x = 72.95, y = 1.19, z = -93.93 },
        [3] = { x = 72.95, y = 1.19, z = -93.93 },
        [4] = { x = 72.95, y = 1.19, z = -93.93 },
      },
      timetoreturn = 12,
    },
    [5] = {
